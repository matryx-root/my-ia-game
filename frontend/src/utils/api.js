...
/* ---- FUNCIONES ESPECÍFICAS DE CONFIGURACIÓN DE USUARIO ---- */
 ...
 */
export function obtenerConfiguracion(usuarioId) {
  return api.get(`/configuracion/${usuarioId}`);
}

/**
 * Guarda o actualiza la configuración del usuario
 * @param {number} usuarioId - ID del usuario
 * @param {Object} config - { tema, idioma, sonido, notificaciones }
 * @returns {Promise<Object>} Configuración guardada
 */
export function guardarConfiguracion(usuarioId, config) {
  return api.put(`/configuracion/${usuarioId}`, config);
}

/**
 * Cambia el tema visual del usuario
 * @param {number} usuarioId - ID del usuario
 * @param {string} tema - "Predeterminado", "Oscuro", "Claro"
 * @returns {Promise<Object>} Configuración actualizada
 */
export function cambiarTema(usuarioId, tema) {
  return api.put(`/configuracion/${usuarioId}`, { tema });
}

/**
 * Activa o desactiva el sonido
 * @param {number} usuarioId - ID del usuario
 * @param {boolean} activado - true o false
 * @returns {Promise<Object>} Configuración actualizada
 */
export function toggleSonido(usuarioId, activado) {
  return api.put(`/configuracion/${usuarioId}`, { sonido: activado });
}
 ...
 * @returns {Promise<Object>} Configuración actualizada
 */
export function toggleNotificaciones(usuarioId, activado) {
  return api.put(`/configuracion/${usuarioId}`, { notificaciones: activado });
}

/**
 * Cambia el idioma (aunque esté en desarrollo)
 * @param {number} usuarioId - ID del usuario
 * @param {string} idioma - "Español", "Inglés"
 * @returns {Promise<Object>} Configuración actualizada
 */
export function cambiarIdioma(usuarioId, idioma) {
  return api.put(`/configuracion/${usuarioId}`, { idioma });
}